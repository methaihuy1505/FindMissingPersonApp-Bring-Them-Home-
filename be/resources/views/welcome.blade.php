...
<body
    ...
    <div
        class="w-full max-w-4xl mx-auto mt-8 mb-12 bg-[#1e293b] rounded-xl shadow-lg border border-[#334155] p-6 text-[#cbd5e1] font-sans">
        <h2 class="text-2xl font-bold text-white mb-6">Các API</h2>

        <div class="mb-6">
            <p class="text-sm text-[#94a3b8] mb-2">Base URL:</p>
            <code
                class="bg-[#0f172a] text-[#4ade80] px-4 py-3 rounded-lg block w-full border border-[#1e293b] break-all font-mono text-sm shadow-inner">https://findmissingpersonapp-bring-them-home.onrender.com</code>
        </div>

        <div class="space-y-4">
            <div class="bg-[#0f172a] p-4 rounded-lg border border-[#334155]">
                <div class="flex flex-col sm:flex-row items-start gap-4">
                    <span
                        class="bg-[#2563eb] text-white px-3 py-1 rounded text-sm font-bold w-[75px] text-center shrink-0">GET</span>
                    <div class="flex-1 text-sm overflow-hidden">
                        <p class="font-mono text-[#93c5fd] text-base mb-1">/api/user</p>
                        <p class="text-[#94a3b8]">Lấy danh sách tất cả người dùng.</p>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-[#0f172a] p-4 rounded-lg border border-[#334155]">
                <div class="flex flex-col sm:flex-row items-start gap-4">
                    <span
                        class="bg-[#16a34a] text-white px-3 py-1 rounded text-sm font-bold w-[75px] text-center shrink-0">POST</span>
                    <div class="flex-1 text-sm overflow-hidden">
                        <p class="font-mono text-[#86efac] text-base mb-1">/api/user</p>
                        <p class="text-[#94a3b8] mb-3">Thêm mới người dùng. Yêu cầu Body (JSON):</p>
                        <pre
                            class="bg-[#020617] p-4 rounded-md text-[#cbd5e1] overflow-x-auto font-mono text-sm border border-[#1e293b] shadow-inner">
{
  "name": "Nguyễn Văn A",
  "email": "nva@example.com"
            ...
            <div class="bg-[#0f172a] p-4 rounded-lg border border-[#334155]">
                <div class="flex flex-col sm:flex-row items-start gap-4">
                    <span
                        class="bg-[#ea580c] text-white px-3 py-1 rounded text-sm font-bold w-[75px] text-center shrink-0">PUT</span>
                    <div class="flex-1 text-sm overflow-hidden">
                        <p class="font-mono text-[#fdba74] text-base mb-1">/api/user/{id}</p>
                        <p class="text-[#94a3b8] mb-3">Cập nhật thông tin (thay {id} bằng ID thực tế). Yêu cầu Body
                            (JSON):</p>
                        <pre
                            class="bg-[#020617] p-4 rounded-md text-[#cbd5e1] overflow-x-auto font-mono text-sm border border-[#1e293b] shadow-inner">
{
  ...
  "email": "nvb_updated@example.com"
            ...
            <div class="bg-[#0f172a] p-4 rounded-lg border border-[#334155]">
                <div class="flex flex-col sm:flex-row items-start gap-4">
                    <span
                        class="bg-[#dc2626] text-white px-3 py-1 rounded text-sm font-bold w-[75px] text-center shrink-0">DELETE</span>
                    <div class="flex-1 text-sm overflow-hidden">
                        <p class="font-mono text-[#fca5a5] text-base mb-1">/api/user/{id}</p>
                        <p class="text-[#94a3b8]">Xóa người dùng (thay {id} bằng ID thực tế).</p>
                    </div>
                </div>
            </div>
        </div>
